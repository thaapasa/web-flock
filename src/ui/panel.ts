...
export interface Panel {
  /**
   * True when something in the panel has the keyboard. Every global key is a
   * bare letter, so typing into a field would otherwise also drive the app.
   */
...
// Slider ranges are wide enough to find the interesting region, not tuned.
